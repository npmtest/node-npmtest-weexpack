...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-weexpack/node_modules/weexpack-common/src/CordovaLogger.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-weexpack/node_modules/weexpack-common/src/CordovaLogger.js</span></h1>
    <h2>
        
        Statements: <span class="metric">83.78% <small>(62 / 74)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">42.5% <small>(17 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">87.5% <small>(7 / 8)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">83.78% <small>(62 / 74)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-weexpack/node_modules/weexpack-common/src/</a> &#187; CordovaLogger.js</div>
</div>
<div class="body">
...
CordovaLogger.prototype.log = function (logLevel, message) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.levels[logLevel] || this.levels[logLevel] &lt; this.levels[this.logLevel])
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (message instanceof Error || <span class="branch-1 cbranch-no" title="branch not covered" >logLevel === CordovaLogger.ERROR)</span> {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this[level]) {
...
CordovaLogger.prototype.setLevel = function (logLevel) {
    this.logLevel = this.levels[logLevel] ? logLevel : <span class="branch-1 cbranch-no" title="branch not covered" >CordovaLogger.NORMAL;</span>
&nbsp;
    return this;
};
&nbsp;
 ...
 * @return  {CordovaLogger}     Current instance, to allow calls chaining.
 */
CordovaLogger.prototype.adjustLevel = <span class="fstat-no" title="function not covered" >function (opts) {</span>
<span class="cstat-no" title="statement not covered" >    if (opts.verbose || (Array.isArray(opts) &amp;&amp; opts.indexOf('--verbose') !== -1)) {</span>
<span class="cstat-no" title="statement not covered" >        this.setLevel('verbose');</span>
    } else <span class="cstat-no" title="statement not covered" >if (opts.silent || (Array.isArray(opts) &amp;&amp; opts.indexOf('--silent') !== -1)) {</span>
<span class="cstat-no" title="statement not covered" >        this.setLevel('error');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this;</span>
};
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!(eventEmitter instanceof EventEmitter))
<span class="cstat-no" title="statement not covered" >        throw new Error('Subscribe method only accepts an EventEmitter instance as argument');</span>
&nbsp;
...
function formatError(error, isVerbose) {
    var message = '';
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (error instanceof CordovaError) {
        message = error.toString(isVerbose);
    } else <span class="cstat-no" title="statement not covered" >if (error instanceof Error) {</span>
<span class="cstat-no" title="statement not covered" >        if (isVerbose) {</span>
<span class="cstat-no" title="statement not covered" >            message = error.stack;</span>
        } else {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof message === 'string' &amp;&amp; message.toUpperCase().indexOf('ERROR:') !== 0) {
